...
public class CompraController {
    ...
    // --- 1. MOSTRAR HISTORIAL DE COMPRAS (Endpoint: /compras/historial) ---
    ...
    // --- 2. DESCARGAR TICKET EN PDF (Endpoint: /compras/ticket/{id}) ---
    @GetMapping("/ticket/{id}") // 🚨 AÑADIDO: Endpoint para descarga
